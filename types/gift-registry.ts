...
export interface TOrganizationGiftRegistry extends TGiftRegistry {
  organization: TOrganization;
}

export interface TReceivedPayout extends TRecievedGift {
  users: TUser;
  giftRegistry: TOrganizationGiftRegistry;
}
